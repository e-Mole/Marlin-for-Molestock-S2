 ...
 */
#define E0_AUTO_FAN_PIN 9 //RAMPS FAN EXTENDER pin D11 (Molestock S2 heatsink fan + LED light, cyclops + chimera) or D9 (cyclops only)//TFs mod
#define E1_AUTO_FAN_PIN 9 //RAMPS FAN EXTENDER pin D11 (Molestock S2 heatsink fan + LED light, cyclops + chimera) or D9 (cyclops only)//TFs mod
