...
//
//#define X_MIN_PIN           3
#define X_MIN_PIN           -1 //TFs mod for Molestock delta (pin D3 - X_MIN for filament runout Sensors for Molestock S2DUAL)
#ifndef X_MAX_PIN
  #define X_MAX_PIN         2
#endif
//#define Y_MIN_PIN          14
#define Y_MIN_PIN          -1 //TFs mod for Molestock delta (pin D14 - Y_MIN for filament runout Sensors for Molestock S2SINGLE/S2DUAL)
#define Y_MAX_PIN          15
#define Z_MIN_PIN          18
#define Z_MAX_PIN          19
...
#if ENABLED(IS_RAMPS_EFB)                      // Hotend, Fan, Bed - Moelstock S to Molestock S2 (cyclops only)
  #define HEATER_BED_PIN   RAMPS_D8_PIN
  #define FAN_PIN        6                     //TFs mod - add material fan pin to RAMPS FAN EXTENDER second pin (cyclops, one heater)
#elif ENABLED(IS_RAMPS_EEF)                    // Hotend, Hotend, Fan
  #define HEATER_1_PIN     RAMPS_D9_PIN
#elif ENABLED(IS_RAMPS_EEB)                    // Hotend, Hotend, Bed - Moelstock S to Molestock S2 (chimera + cyclops)
  #define HEATER_1_PIN   RAMPS_D9_PIN
  #define HEATER_BED_PIN RAMPS_D8_PIN
  #define FAN_PIN        6                     //TFs mod - add fan pin to RAMPS FAN EXTENDER second pin (cyclops or chimera, two heaters)
...
// RAMPS 1.4 DIO 4 on the servos connector
  ...
  #define FIL_RUNOUT_PIN     14 // TFs mod for Molestock S2 SINGLE/DUAL delta (need 3 or 14)
  #define FIL_RUNOUT2_PIN     3 // TFs mod for Molestock S2 DUAL delta (need 3 and 14)
#endif
