 ...
 */
  ...
  inline bool position_is_reachable(const float &rx, const float &ry, const float inset=0) {
        ...
        //TFs test (remove in production ver.)
        //SERIAL_PROTOCOLPAIR("RX:", rx);
        //SERIAL_PROTOCOLPAIR("RY:", ry);      
      
      //return HYPOT2(rx, ry) <= sq(DELTA_PRINTABLE_RADIUS - inset); //TFs mod
  	  	...
  	  	if ( ((rx == Z_PROBE_ALLEN_KEY_DEPLOY_1_X) && (ry == Z_PROBE_ALLEN_KEY_DEPLOY_1_Y)) ||
             ...
             ((rx == (Z_PROBE_ALLEN_KEY_DEPLOY_1_X - (X_PROBE_OFFSET_FROM_EXTRUDER))) && (ry == (Z_PROBE_ALLEN_KEY_DEPLOY_1_Y - (Y_PROBE_OFFSET_FROM_EXTRUDER)))) ||
             ((rx == (Z_PROBE_ALLEN_KEY_DEPLOY_2_X - (X_PROBE_OFFSET_FROM_EXTRUDER))) && (ry == (Z_PROBE_ALLEN_KEY_DEPLOY_2_Y - (Y_PROBE_OFFSET_FROM_EXTRUDER)))) ||
             ((rx == (Z_PROBE_ALLEN_KEY_DEPLOY_3_X - (X_PROBE_OFFSET_FROM_EXTRUDER))) && (ry == (Z_PROBE_ALLEN_KEY_DEPLOY_3_Y - (Y_PROBE_OFFSET_FROM_EXTRUDER)))) ||
             ((rx == (Z_PROBE_ALLEN_KEY_STOW_1_X - (X_PROBE_OFFSET_FROM_EXTRUDER))) && (ry == (Z_PROBE_ALLEN_KEY_STOW_1_Y - (Y_PROBE_OFFSET_FROM_EXTRUDER)))) ||
             ((rx == (Z_PROBE_ALLEN_KEY_STOW_2_X - (X_PROBE_OFFSET_FROM_EXTRUDER))) && (ry == (Z_PROBE_ALLEN_KEY_STOW_2_Y - (Y_PROBE_OFFSET_FROM_EXTRUDER)))) ||
             ((rx == (Z_PROBE_ALLEN_KEY_STOW_3_X - (X_PROBE_OFFSET_FROM_EXTRUDER))) && (ry == (Z_PROBE_ALLEN_KEY_STOW_3_Y - (Y_PROBE_OFFSET_FROM_EXTRUDER)))) ||             
			       ((rx == EXTRA_POS_1_X) && (ry == EXTRA_POS_1_Y)) ||
			       ((rx == EXTRA_POS_2_X) && (ry == EXTRA_POS_2_Y))
  		  ) {
  	  		  //SERIAL_PROTOCOLLNPGM("Allowed EXTRA move, potentially outside printable area.");//TFs test (remove in production ver.)
  	  		  return true;
  	  	} else {
